package com.bradengoodwin.bimken.core.init.network.message;
...
public class InputMessage {
    ...
    public InputMessage(int key){
     ...
     public static void handle(InputMessage message,
        ...
        context.enqueueWork(() -> {
            ...
            world.setBlockAndUpdate(player.blockPosition().below(),
